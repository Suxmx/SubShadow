Shader "Custom/CharacterLitShader"
{
    Properties
    {
        ...
        _TurnColor ("TurnColor", Int) = 0
        [HideInInspector]_WhiteColor("WhiteColor",Color)=(1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform int _TurnColor;
            uniform float4 _WhiteColor;
            #include "Packages/com.unity.render-pipelines.universal/Shaders/2D/Include/CombinedShapeLightShared.hlsl"
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                half4 main = i.color * SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv);
                if(_TurnColor&&main.rgba.a==1){
                    main.rgba+=_WhiteColor;
                    return main;
                }
